    ...
    <section className="relative min-h-[100vh] flex items-center justify-center overflow-hidden bg-mesh pt-24 pb-20">
      <div className="absolute top-4 md:top-8 right-4 md:right-8 z-50">
        <Button
          variant="outline"
          size="icon"
          className="h-10 w-10 rounded-full bg-white/50 dark:bg-black/20 backdrop-blur-md border-blue-200 dark:border-white/10 text-blue-900 dark:text-white shadow-sm hover:bg-white/80 dark:hover:bg-white/10 transition-all hover:scale-105"
      ...
      {/* Decorative Elements */}
      <div className="absolute top-1/4 -left-20 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl animate-float shadow-[0_0_50px_rgba(13,59,102,0.1)]" />
      <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-blue-600/10 rounded-full blur-3xl animate-float-delayed shadow-[0_0_50px_rgba(13,59,102,0.1)]" />

      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-blue-50/80 dark:bg-blue-950/30 border border-blue-500/20 mb-8 animate-fade-up shadow-[0_0_20px_rgba(13,59,102,0.05)] backdrop-blur-sm">
          <div className="bg-white/90 dark:bg-white/10 backdrop-blur-md p-1 rounded-xl border border-blue-500/20 shadow-sm transition-transform hover:scale-105">
            <Image
              src="/vesit-logo.png"
              alt="VESIT Logo"
              width={160}
          ...
          <div className="w-[1px] h-8 bg-blue-500/20 mx-1" />
          <span className="text-[10px] md:text-xs font-bold tracking-widest uppercase text-blue-500/80 pr-2">
            Official Alumni Network of VESIT
          </span>
        </div>

        <div className="flex justify-center mb-6 animate-fade-in group">
          <div className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-blue-500/10 border border-blue-500/20 hover:bg-blue-500/20 transition-all shadow-[0_0_15px_rgba(13,59,102,0.1)]">
        ...
        <div className="relative p-8 md:p-12 rounded-[2.5rem] bg-gradient-to-br from-blue-200/80 via-blue-50/50 to-blue-300/80 dark:bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] dark:from-[#1e3a8a]/40 dark:via-[#0f172a]/80 dark:to-[#020617] backdrop-blur-md border border-blue-500/20 shadow-[0_0_100px_rgba(13,59,102,0.15)] animate-fade-up">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 leading-[1.1]">
            Connecting Generations, <br />
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 animate-gradient-shift">
              Building Excellence.
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animationDelay: '0.4s' }}>
            <Button asChild size="lg" className="rounded-full h-14 px-8 text-base font-bold shadow-xl hover:shadow-blue-500/20 transition-all group bg-blue-500 hover:bg-blue-600 border-none">
              <Link href="/register">
                Join Now <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="rounded-full h-14 px-8 text-base font-bold bg-white/50 dark:bg-white/5 backdrop-blur-md border-blue-200 dark:border-white/10 text-blue-900 dark:text-white hover:bg-blue-50 dark:hover:bg-white hover:text-blue-950 dark:hover:text-black transition-all shadow-sm hover:shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 max-w-4xl mx-auto animate-fade-up" style={{ animationDelay: '0.6s' }}>
          <div className="p-6 rounded-2xl bg-white/60 dark:bg-white/[0.03] backdrop-blur-lg border border-blue-100 dark:border-white/10 shadow-sm flex items-center gap-4 text-left hover:bg-blue-50 dark:hover:bg-white/[0.05] transition-all">
            <div className="bg-primary/10 p-3 rounded-xl text-primary dark:text-accent">
