      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-black mb-6 animate-fade-up">
            ...
            <span className="text-primary dark:text-accent">Career Success.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="group p-8 rounded-3xl bg-blue-50/50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-500/10 hover:border-blue-300 dark:hover:border-blue-500/40 hover:bg-blue-100/50 dark:hover:bg-blue-500/5 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(13,59,102,0.1)]"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="w-14 h-14 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-6 border border-blue-200 dark:border-blue-500/20 group-hover:scale-110 group-hover:bg-blue-500 group-hover:shadow-[0_0_20px_rgba(13,59,102,0.4)] transition-all duration-500">
