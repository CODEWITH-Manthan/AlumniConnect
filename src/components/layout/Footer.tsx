...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-auto border-t border-blue-500/20 bg-black text-primary-foreground overflow-hidden">
      {/* Decorative blobs */}
      <div className="pointer-events-none absolute -top-24 -left-16 w-72 h-72 rounded-full bg-blue-500/10 blur-3xl opacity-40 shadow-[0_0_50px_rgba(13,59,102,0.1)]" />
      <div className="pointer-events-none absolute -bottom-16 right-0 w-64 h-64 rounded-full bg-blue-600/10 blur-3xl opacity-30 shadow-[0_0_50px_rgba(13,59,102,0.1)]" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1 space-y-4">
            <Link href="/" className="flex items-center gap-2.5 group w-fit">
              <div className="bg-blue-500 p-2 rounded-lg transition-transform group-hover:scale-110 shadow-[0_0_15px_rgba(13,59,102,0.3)]">
                <GraduationCap className="h-5 w-5 text-white" />
              </div>
              <span className="text-xl font-headline font-bold tracking-tight text-white group-hover:text-blue-400 transition-colors">
                AlumniConnect
              </span>
            </Link>
